...
```{r}
include_graphics("../assets/img/overall_overview.jpeg")
```
...
```{r}
include_graphics("../assets/img/features.jpeg")
```
...
```{r}
include_graphics("../assets/img/age.jpeg")
```
...
```{r}
include_graphics("../assets/img/art_classes.jpeg")
```
...
```{r}
include_graphics("../assets/img/price_increase.jpeg")
```

```{r}
include_graphics("../assets/img/price_increase_relative.jpeg")
```
...
```{r}
include_graphics("../assets/img/artists.jpeg")
```

```{r}
include_graphics("../assets/img/artists_per_piece.jpeg")
```
