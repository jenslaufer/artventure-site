...
valueBox %>%
  finalise_plot(source_name = "Source: https://artventure.me Data Source: https://expressobeans.com",
                width_pixels = 450,
                height_pixels = 200,
                save_filepath = "../_site/overall_overview.jpeg",
...
art_class_plot %>%
  finalise_plot(source_name = "Source: https://artventure.me Data Source: https://expressobeans.com",
                width_pixels = 450,
                height_pixels = 200,
                save_filepath = "../_site/art_classes.jpeg",
                logo_image_path = "../assets/img/logo.png")
...
price_increase_plot %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 500,
    save_filepath = "../_site/price_increase.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
...
price_increase__relative_plot %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 500,
    save_filepath = "../_site/price_increase_relative.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
```
...
artist_plot_total %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 250,
    save_filepath = "../_site/artists.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
...
artist_plot_per_piece %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 250,
    save_filepath = "../_site/artists_per_piece.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
...
features_plot %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 250,
    save_filepath = "../_site/features.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
```
...
```{r}
include_graphics("../_site/overall_overview.jpeg")
```
...
```{r}
include_graphics("../_site/features.jpeg")
```
...
```{r}
include_graphics("../_site/age.jpeg")
```
...
```{r}
include_graphics("../_site/art_classes.jpeg")
```
...
```{r}
include_graphics("../_site/price_increase.jpeg")
```

```{r}
include_graphics("../_site/price_increase_relative.jpeg")
```
...
```{r}
include_graphics("../_site/artists.jpeg")
```

```{r}
include_graphics("../_site/artists_per_piece.jpeg")
```
