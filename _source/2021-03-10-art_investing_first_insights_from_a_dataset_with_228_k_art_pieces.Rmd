...
valueBox %>%
  finalise_plot(source_name = "Source: https://artventure.me Data Source: https://expressobeans.com",
                width_pixels = 450,
                height_pixels = 200,
                save_filepath = "../assets/img/overall_overview.jpeg",
...
art_class_plot %>%
  finalise_plot(source_name = "Source: https://artventure.me Data Source: https://expressobeans.com",
                width_pixels = 450,
                height_pixels = 200,
                save_filepath = "../assets/img/art_classes.jpeg",
                logo_image_path = "../assets/img/logo.png")
...
age_plot %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 250,
    save_filepath = "../assets/img/age.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
...
price_increase_plot %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 500,
    save_filepath = "../assets/img/price_increase.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
...
price_increase__relative_plot %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 500,
    save_filepath = "../assets/img/price_increase_relative.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
```
...
artist_plot_total %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 250,
    save_filepath = "../assets/img/artists.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
...
artist_plot_per_piece %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 250,
    save_filepath = "../assets/img/artists_per_piece.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
...
features_plot %>%
  finalise_plot(
    ...
    width_pixels = 500,
    height_pixels = 250,
    save_filepath = "../assets/img/features.jpeg",
    logo_image_path = "../assets/img/logo.png"
  )
```
...
![Art Investor's Data Set Overview](/assets/img/overall_overview.jpeg)
...
![Art Investor's Data Set Features](/assets/img/features.jpeg)
...
![Art Investor's Data Set Art pieces Age](/assets/img/age.jpeg)
...
![Art Investor's Data Set Art classes](/assets/img/art_classes.jpeg)
...
![Art Investor's Data Set Absolute Price Increase](/assets/img/price_increase.jpeg)

![Art Investor's Data Set Relative Price Increase](/assets/img/price_increase_relative.jpeg)
...
![Art Investor's Data Set Artists with highest absolute price increase](/assets/img/artists.jpeg)

![Art Investor's Data Set Artists with highest average price increase per piece](/assets/img/artists_per_piece.jpeg)
