...
art_class_plot <- art_classes %>%
  ...
  bbc_style() +
  labs(title = "An Art Investor's Data Set", subtitle = "Most Common Art Classes", caption = "test        <img src='https://upload.wikimedia.org/wikipedia/commons/f/f7/Stack_Overflow_logo.png' width='60'/>") +
  theme(axis.text.x = element_blank(), plot.caption = element_markdown(hjust = 0)) 
