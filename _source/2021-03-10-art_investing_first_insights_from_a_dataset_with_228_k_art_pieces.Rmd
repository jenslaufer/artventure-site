...
To gain insights from the data with an analyst's toolset I developed a web scraper in Python which pumped the data into a MongoDB database. From the database, I was able to do a first exploratory data analysis (EDA) with the help of R, which I like more for data analysis than Python.

In this article, I want to share the results of the first analysis. In case you are interested in the data set you can drop me [message](mailto:jens@artventure.com).
...
Art is a very broad topic. My question, that interested me from the beginning was how old the art pieces in the data set. You can see that about 80% are from the last 20 years. The oldest art piece in the data set is from 1662.

So you can say the data set is about modern art.
...
As an investor in art, I am interested in what the art pieces with the highest price increases are instead of looking for the most valuable artwork. Remember, I want to invest in art that I love I can for a low price with the potential for a high price increase.
...
### Which are artists have the highest price increase for their artwork?

By adding up all absolute price increases for all the artists I want to get insights into which artists have the highest total price increase. As some artists created more pieces than others I created also a chart with the artists with the highest average price per piece.

Although there are different names on top of the two charts, there a lot of overlaps. The names on the list are a good first starting point for investments.
